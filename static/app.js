...
var _preventExtensions = __webpack_require__(87);

var _preventExtensions2 = _interopRequireDefault(_preventExtensions);

var _isExtensible = __webpack_require__(61);
...
var _getOwnPropertyNames = __webpack_require__(36);
...
var _defineProperties = __webpack_require__(25);
...
var _ownKeys = __webpack_require__(88);
...
function resolveInject(inject, vm) {
  if (inject) {
    ...
    var keys = isArray ? inject : hasSymbol ? (0, _ownKeys2.default)(inject) : (0, _keys2.default)(inject);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(80), __webpack_require__(154)))
...
exports.mapActions = exports.mapGetters = exports.mapMutations = exports.mapState = exports.Store = undefined;
...
var Module = function Module(rawModule, runtime) {
  ...
  this._children = (0, _create2.default)(null);
...
(0, _defineProperties2.default)(Module.prototype, prototypeAccessors$1);
...
var Store = function Store(options) {
  ...
  this._wrappedGetters = (0, _create2.default)(null);
  this._modules = new ModuleCollection(options);
  this._modulesNamespaceMap = (0, _create2.default)(null);
  this._subscribers = [];
...
Store.prototype.dispatch = function dispatch(_type, _payload) {
  ...
  return entry.length > 1 ? _promise2.default.all(entry.map(function (handler) {
...
(0, _defineProperties2.default)(Store.prototype, prototypeAccessors);

function resetStore(store, hot) {
  store._actions = (0, _create2.default)(null);
  store._mutations = (0, _create2.default)(null);
  store._wrappedGetters = (0, _create2.default)(null);
  store._modulesNamespaceMap = (0, _create2.default)(null);
...
function makeLocalContext(store, namespace, path) {
  ...
  (0, _defineProperties2.default)(local, {
    getters: {
...
function makeLocalGetters(store, namespace) {
  ...
  (0, _keys2.default)(store.getters).forEach(function (type) {
    ...
    (0, _defineProperty2.default)(gettersProxy, localType, {
      get: function get() {
...
function unifyObjectStyle(type, payload, options) {
  ...
  assert(typeof type === 'string', "Expects string as the type, but found " + (typeof type === 'undefined' ? 'undefined' : (0, _typeof3.default)(type)) + ".");
...
exports.default = new _vuex2.default.Store({
  modules: {
    state: 1,
    mutations: (_mutations = {}, (0, _defineProperty3.default)(_mutations, INCREASE, function (state) {
      state += 1;
    }), (0, _defineProperty3.default)(_mutations, DECREASE, function (state) {
      state -= 1;
    }), _mutations),
    actions: (_actions = {}, (0, _defineProperty3.default)(_actions, INCREASE, function (_ref) {
      var commit = _ref.commit;

      commit(INCREASE);
    }), (0, _defineProperty3.default)(_actions, DECREASE, function (_ref2) {
...
var USE_NATIVE = !!function () {
  try {
    ...
    var promise = $Promise.resolve(1),
        FakePromise = (promise.constructor = {})[__webpack_require__(2)('species')] = function (exec) {
      exec(empty, empty);
    };
...
new _vue2.default({
  ...
  methods: (0, _extends3.default)({}, (0, _vuex.mapActions)({
    increase: _Types2.default.INCREASE,
    decrease: _Types2.default.DECREASE
  }))
});
...
Component.options.__file = "/Users/xiaohuajun/Documents/github/kyrios/src/components/Home.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-007c3475", Component.options)
  } else {
    hotAPI.reload("data-v-007c3475", Component.options)
  }
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('h1', [_vm._v(_vm._s(_vm.count))])
},staticRenderFns: []}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-007c3475", module.exports)
  }
}
...
var update = __webpack_require__(161)("d97a3e1a", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-007c3475\",\"scoped\":false,\"hasInlineConfig\":false}!../../node_modules/stylus-loader/index.js!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Home.vue", function() {
     var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-007c3475\",\"scoped\":false,\"hasInlineConfig\":false}!../../node_modules/stylus-loader/index.js!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Home.vue");
